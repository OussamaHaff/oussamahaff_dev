...
date: "2019-07-27"
description: In this article I will focus on the problem-solving mindset behind resolving
  a mysterious bug that we have faced when trying to publish our Android App using
  the new format App Bundle instead of APK for the first time
tags:
- Debug
- Dependencies
- Android
